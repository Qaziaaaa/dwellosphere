...
describe('BookingService', () => {
  ...
  describe('create', () => {
    ...
    it('should throw NotFoundException if property missing', async () => {
      ...
      await expect(service.create(dto, 'tenant1')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('findByTenant', () => {
    it('should return tenant bookings', async () => {
      mockPrisma.booking.findMany.mockResolvedValue([
        { id: 'b1', property: { id: 'p1', title: 'Test', images: '' } },
      ]);
  ...
  describe('findByAgent', () => {
    it('should return agent bookings', async () => {
      mockPrisma.booking.findMany.mockResolvedValue([
        {
          id: 'b1',
          property: { id: 'p1', title: 'Test', images: '' },
          tenant: {
            id: 't1',
            firstName: 'Tenant',
            lastName: 'T',
  ...
  describe('updateStatus', () => {
    ...
    it('should throw ForbiddenException for wrong agent', async () => {
      ...
      await expect(
        service.updateStatus('b1', dto, 'wrong-agent', 'agent'),
    ...
    it('should throw NotFoundException for nonexistent booking', async () => {
      ...
      await expect(
        service.updateStatus('b1', dto, 'user', 'agent'),
